...
import { EmoticonButtonComponent } from '../emoticon-button/emoticon-button.component';
...
@Component({
  ...
  imports: [AvatarComponent, UserPreviewComponent, RouterModule, DatePipe, EmoticonButtonComponent],
})
